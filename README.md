...
O Jobs Bot é um bot que busca novas vagas de emprego no LinkedIn através de um feed RSS, filtra as vagas com base em palavras-chave, analisa a compatibilidade com o seu currículo e envia as melhores para um quadro do Trello.
...
O resultado da análise é adicionado ao card do Trello, facilitando a decisão de se candidatar ou não para a vaga. O título do card conterá a porcentagem de compatibilidade, e a descrição terá os detalhes da análise.
