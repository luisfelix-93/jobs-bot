...
Bonn - NordRhein Westphallen \| +55 79 99910-7236 \|
[[luis.felix.filho@hotmail.com]{.underline}](mailto:luis.felix.filho@hotmail.com)
\|
[[linkedin.com/in/luisfelixfilho]{.underline}](http://linkedin.com/in/luisfelixfilho)

## Professional Summary

Site Reliability & Platform Engineer with 5+ years of experience
designing, automating, and maintaining scalable cloud infrastructures
and CI/CD pipelines.

Proficient in Kubernetes, Docker, GitHub Actions, ArgoCD, and Azure
DevOps, with proven expertise in optimizing deployment workflows,
increasing delivery velocity, and ensuring system reliability.

Strong background in monitoring and observability (Grafana, Prometheus),
asynchronous architectures (RabbitMQ), and infrastructure-as-code
(Terraform).

Focused on building resilient, automated, and measurable DevOps
solutions that enhance software delivery performance and operational
efficiency

## Professional Experience

Ligo (São Paulo, Brazil - Remote)

Intermediate Software Engineer (Platform & SRE Focus)
...
-   Built resilient **.NET microservices** and **REST APIs** with 99.9%
    > uptime, **supporting 10k+ daily requests.**

-   Implemented asynchronous queues with **RabbitMQ** to improve
    > throughput and **reduce job processing time by 50%**.

-   Introduced **unit testing frameworks (NUnit)**, cutting regression
    > defects by 25% and increasing release safety.

-   Improved cross-team collaboration by formalising API contracts
    > **(Swagger, Postman)**, **reducing integration issues by 40%**.

-   Actively contributed to **Agile** ceremonies, **helping identify
    > bottlenecks** and increasing sprint velocity by 15%.

Menendez & Menedez (Aracaju, Brazil - On Site)

Early Engineering Experience (Development & Automation)
...
Polytechnic University of Orléans (France)

Exchange Program in Energy, Aeronautics & Engine Technologies
